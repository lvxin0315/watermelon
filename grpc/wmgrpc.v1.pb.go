...
var fileDescriptor_e7f29f673d8a61db = []byte{
	...
	0x57, 0x0f, 0x6a, 0x32, 0xd8, 0x14, 0x29, 0x3e, 0x18, 0x17, 0x62, 0x96, 0x12, 0x83, 0x91, 0x2d,
	0x17, 0x7f, 0x78, 0x6a, 0x52, 0x70, 0x7e, 0x72, 0x76, 0x6a, 0x09, 0xe9, 0xda, 0x93, 0xd8, 0xc0,
	0xce, 0x35, 0x06, 0x04, 0x00, 0x00, 0xff, 0xff, 0xaf, 0x0c, 0x5b, 0x58, 0xc6, 0x00, 0x00, 0x00,
}
...
func (c *webSocketServerClient) GetData(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Result, error) {
	out := new(Result)
	err := c.cc.Invoke(ctx, "/wmgrpc.WebSocketServer/GetData", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedWebSocketServerServer) GetData(ctx context.Context, req *Empty) (*Result, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetData not implemented")
}
...
func _WebSocketServer_GetData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WebSocketServerServer).GetData(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/wmgrpc.WebSocketServer/GetData",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WebSocketServerServer).GetData(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
